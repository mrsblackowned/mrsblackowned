  ...
  <section className="py-24 px-6 bg-secondary text-primary text-center">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      <div className="bg-white p-6 rounded shadow hover:shadow-lg transition">
        <img src="/book-cover.svg" alt="Book Cover" className="mb-4 rounded w-full" />
      ...
      <div className="bg-white p-6 rounded shadow hover:shadow-lg transition">
        <img src="/editorial1.svg" alt="Editorial 1" className="mb-4 rounded w-full" />
      ...
      <div className="bg-white p-6 rounded shadow hover:shadow-lg transition">
        <img src="/editorial2.svg" alt="Editorial 2" className="mb-4 rounded w-full" />
        <h3 className="font-semibold text-xl mb-2">Editorial Feature</h3>
